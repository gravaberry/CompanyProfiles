...
<body class="bg-gradient-warning">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ asset('loginbi/proses_bi') }}" method="POST" accept-charset="utf-8">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="email" name="email" :value="old('email')" required autofocus aria-describedby="emailHelp"
    ...
    <script>
        ...
        swal.fire("Mohon Maaf", "<?php echo $message ?> ", "warning")
