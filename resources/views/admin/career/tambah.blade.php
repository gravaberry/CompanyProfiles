...
<form action="{{ asset('admin/career/proses_tambah') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
    @csrf
    ...
    <div class="row form-group">
        ...
        <div class="col-md-9">
            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="isi title" class="form-control">
          @error('title')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                  @enderror
        </div>
    ...
    <div class="row form-group">
      ...
      <div class="col-md-9">
        <textarea name="deskripsi" class="form-control" id="kontenku" id="deskripsi" placeholder="keterangan">{{ old('deskripsi') }}</textarea>
        @error('deskripsi')
                  <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
      </div>
